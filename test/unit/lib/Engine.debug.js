...
var Engine3D;
(function (Engine3D) {
    var EventMouseHandler = (function (_super) {
        __extends(EventMouseHandler, _super);
        function EventMouseHandler() {
            _super.apply(this, arguments);
        }
        EventMouseHandler.getInstance = function () {
            if (this._instance === null) {
                this._instance = new this();
            }
            return this._instance;
        ...
        //public off(args) {
        EventMouseHandler.prototype.off = function (view, eventType, handler) {
        ...
        EventMouseHandler.prototype.trigger = function (target, eventObject, handler) {
        ...
        //}
        EventMouseHandler.prototype._isTrigger = function (result) {
            return result && result.getCount() > 0;
        };
        EventMouseHandler.prototype._createEventObject = function (event, eventType, currentTarget) {
            var obj = Engine3D.MouseEvent.create(event ? event : window.event, eventType);
            obj.currentTarget = currentTarget;
            return obj;
        };
        EventMouseHandler._instance = null;
        return EventMouseHandler;
    })(Engine3D.EventHandler);
    Engine3D.EventMouseHandler = EventMouseHandler;
})(Engine3D || (Engine3D = {}));
            ...
            if (arguments.length === 0) {
                ...
                switch (eventCategory) {
                    case Engine3D.EventCategory.MOUSE:
                        handler = Engine3D.EventMouseHandler.getInstance();
                        break;
                    //todo more type
                    default:
