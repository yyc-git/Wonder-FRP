...
var MockObserver = (function (_super) {
    ...
    MockObserver.prototype.onNext = function (value) {
        ...
        if (JudgeUtils_1.JudgeUtils.isDirectObject(value)) {
            record = Record_1.Record.create(this._scheduler.clock, value, ActionType_1.ActionType.NEXT, function (a, b) {
                var result = true;
                for (var i in a) {
            ...
            record = Record_1.Record.create(this._scheduler.clock, value, ActionType_1.ActionType.NEXT);
        }
        this._messages.push(record);
    };
    MockObserver.prototype.onError = function (error) {
        this._messages.push(Record_1.Record.create(this._scheduler.clock, error, ActionType_1.ActionType.ERROR));
    };
    MockObserver.prototype.onCompleted = function () {
        this._messages.push(Record_1.Record.create(this._scheduler.clock, null, ActionType_1.ActionType.COMPLETED));
    };
